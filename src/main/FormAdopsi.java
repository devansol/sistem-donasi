...
public class FormAdopsi extends javax.swing.JFrame {
    ...
    public FormAdopsi() throws Exception {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("List Data Adopsi");
        ...
        jMenuItem1.setText("Lihat Data Adopsi");
    ...
    private void tambahDonasiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tambahDonasiActionPerformed
        ...
        FormTambahAdopsi form;
        try {
            form = new FormTambahAdopsi();
            form.setVisible(true);
            form.setTitle("Form Tambah Adopsi");
        } catch (Exception ex) {
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        ...
        try {
            ...
            SessionEntity.setNo_adopsi(tableAdopsi.getValueAt(i, 1).toString());
            ModalViewDataAdopsi modal;
            this.setVisible(false);
            modal = new ModalViewDataAdopsi();
            modal.setTitle("Form View Data Adopsi");
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    Logger.getLogger(FormAdopsi.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
...
//                    tgl_rekam_medis.setText(tanggal+"-"+(bulan1+1)+"-"+tahun);
    ...
    private void getAllAdopsi() throws Exception{
        ...
        try{
            response = service.getAllAdopsi();
            int index=0;
            for (AdopsiEntity entity : response) {
               index+=1;
                Object[] obj = new Object[4];
                obj[0] = index;
                obj[1] = entity.getNo_adopsi();
                obj[2] = entity.getNama_adopsi();
                obj[3] = entity.getNama_anak();
                model.addRow(obj);
            }
        }catch(Exception e){
            JOptionPane.showMessageDialog(null, e.getMessage());
