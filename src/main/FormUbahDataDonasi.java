 ...
 * @author Daus
 */
public class FormUbahDataDonasi extends javax.swing.JFrame {

    /**
     * Creates new form FormUbahDataDonasi
     */
    
    DonasiService service = new DonasiService();
    public FormUbahDataDonasi() throws Exception {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Form Ubah Donasi");
        ...
        try{
            if(namaDonatur.getText().equals("")){
                ...
                if(flag == 0){
                    ...
                    if(arr.length != 1){
                        array = arr[1].split("\\\\");
                        format = array[array.length - 1].split("\\.");
                        entity.setBukti_pembayaran(array[array.length - 1]);
                    }else{
                        
                        format = buktiPembayaran.getText().split("\\.");
                        ...
                        if(format[format.length - 1 ].equals("jpeg") || format[format.length - 1 ].equals("jpg")
                            ...
                            response = service.ubahDataDonasi(entity);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormUbahDataDonasi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new FormUbahDataDonasi().setVisible(true);
                } catch (Exception ex) {
                    Logger.getLogger(FormUbahDataDonasi.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
...
//                    tgl_rekam_medis.setText(tanggal+"-"+(bulan1+1)+"-"+tahun);
    ...
    private void getLoadDataDonasiByNoDonasi() throws Exception {
        ...
        try{
            ...
            buktiPembayaran.setText(response.getBukti_pembayaran());
