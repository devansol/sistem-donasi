 ...
 * @author Daus
 */
public class FormTambahAdopsi extends javax.swing.JFrame {

    /**
     * Creates new form FormTambahAdopsi
     */
    
    private AdopsiService service = new AdopsiService();
    private AnakService serviceAnak = new AnakService();
    
    public FormTambahAdopsi() throws Exception {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Form Tambah Adopsi");
        ...
        try{
            if(namaAdopsi.getText().equals("")){
                ...
                if(flag == 0){
                    ...
                    Map<String,Object> response = service.insertAdopsi(param);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormTambahAdopsi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    FormTambahAdopsi form = new FormTambahAdopsi();
                    form.setVisible(true);
                } catch (Exception ex) {
                    Logger.getLogger(FormTambahAdopsi.class.getName()).log(Level.SEVERE, null, ex);
                }
...
//                    tgl_rekam_medis.setText(tanggal+"-"+(bulan1+1)+"-"+tahun);
    ...
    private void getNoAdopsi() throws Exception {
        String no_adopsi = "";
        try{
            no_adopsi = service.getNoAdopsi();
            noAdopsi.setText(no_adopsi);
        }catch(Exception e){
            JOptionPane.showMessageDialog(null, e.getMessage());
        }
    }
