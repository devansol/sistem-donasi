 ...
 * @author Daus
 */
public class FormCetakLaporanAdopsi extends javax.swing.JFrame {

    /**
     * Creates new form FormCetakLaporanAdopsi
     */
    public FormCetakLaporanAdopsi() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Form Cetak Laporan Adopsi");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormCetakLaporanAdopsi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormCetakLaporanAdopsi().setVisible(true);
            }
        });
    }
